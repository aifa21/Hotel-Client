...
import logo from "../images/boat.PNG";
...
function Login() {
  ...
  const { user,signInUsingGoogle,handleSignInEmail,handleCreateEmail,error,handlePasswordReset,setUserName,verifyEmail  } = useAuth();
          ...
          <div className="login-container">
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <br />
              {
                ...
                placeholder="Email address: reafat@gmail.com"
                required
              />
                )
              }
            ...
            <p style={{ textAlign: "center" }}>
              {!registered ? "Already have an account ? " : "Don't have account ?"}
              <span
